...
# 모델 속성 : 데이터베이스 테이블의 컬럼 = 모델 클래스의 속성 = 모델 클래스의 필드 (ORM)
    ...
    author = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name="my_posts")
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name="my_comments")
    content = models.TextField()
    create_dt = models.DateTimeField(auto_now_add=True)
